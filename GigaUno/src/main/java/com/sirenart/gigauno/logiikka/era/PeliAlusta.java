...
public class PeliAlusta {
    public static final int aloitusKorttiMaara = 6;
    ...
    private void jaaAloitusKortit(){
        for(int i = 0; i < aloitusKorttiMaara; i++){
            for(Pelaaja pelaaja : pelaajat){
     ...
     * ja laittaa muistiin kortit, että ne voidaan näyttää jatkossa grafisesti pelaajalle
     */
    ...
    public void pelaajaPaljastaaToisenUnon(){
